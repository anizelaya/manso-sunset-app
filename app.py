...
# Datos de prueba por si la planilla todavía está vacía
if not eventos:
    eventos = [
        {
            "id": 1,
    ...
    for evento in eventos_filtrados:
        with st.container():
            ...
            with col_img:
                ...
                # Corregido aquí para evitar el error de versión de Streamlit
            ...
            with col_info:
                ...
                if "Solo Entrada" in tipo_experiencia:
                    ...
                    with st.form(key=f"form_wpp_{evento.get('id')}"):
                        ...
                        ubicacion_salida = st.text_input("¿De dónde salimos a buscarte? (Dirección / Hotel)", key=f"ubi_{evento.get('id')}")
                        ...
                        if enviar_wpp:
                            if not nombre_persona or not ubicacion_salida:
                                ...
                                telefono_destino = "5492613358860"  # Reemplazá con tu número
                                texto_mensaje = (
